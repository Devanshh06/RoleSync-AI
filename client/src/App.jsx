 ...
 * Sidebar state lifted here so Navbar hamburger can control it.
 */
const AppLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 sm:p-6 lg:p-10 overflow-y-auto h-[calc(100vh-64px)] relative">
...
/**
 * AppContent — needs to be inside AuthProvider to use useAuth
 */
const AppContent = () => {
